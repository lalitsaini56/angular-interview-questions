...
You can download the PDF and Epub version of this repository from the latest run on the [actions tab](https://github.com/lalitsaini56/angular-interview-questions/actions).
